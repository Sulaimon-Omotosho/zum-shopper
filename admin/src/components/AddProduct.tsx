...
const formSchema = z.object({
  ...
  price: z.number().min(1, { message: 'Price of product is required!' }),
  shortDescription: z
    .string()
    .min(1, { message: 'Add short description of product' })
    .max(50, { message: 'Description is too long' }),
  description: z
    .string()
    .min(10, { message: 'Add short description of product' }),
